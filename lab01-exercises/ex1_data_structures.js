...
years = years.concat([newYear]); // make number combine into array
...
for (var i = 0; i < names.length; i++) {
  ...
  museums[currentName] = {};
  museums[currentName]["URL"] = currentURL; // can be .url but not for space or special char
...
addAMuseum(museums2, 'MoMath', 'momath.org', 1999);
